...
class _AdressesWidgetState extends State<AdressesWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Adresses'});
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'Поиск по городу или адресу',
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADRESSES_PAGE_Column_nx5fllto_ON_TAP');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADRESSES_PAGE_Column_ks8q9bsv_ON_TAP');
                            logFirebaseEvent('Column_navigate_to');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADRESSES_PAGE_Column_ejbsaumj_ON_TAP');
                            logFirebaseEvent('Column_navigate_to');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADRESSES_PAGE_Column_u4mg5vxo_ON_TAP');
                            logFirebaseEvent('Column_navigate_to');
